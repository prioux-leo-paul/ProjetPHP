...
echo "
    ...
    <li>". $current_product->get("stock")." produit en stock </li>
    <li>" . $current_product->get("descriptionProduit")."</li>
    <li>" . $current_product->get("prix")."</li>";
    ?>
    /*<form method="POST" action="index.php?controller=produit&action=showproduct&param=<?php echo $current_product->get("numProduit")?> ">
